...
<div align="center">
  <p align="center">
    <img src="./Screenshot/logo.png" alt="Logo" width="450" height="150" >
    <h1> NoteNest - Cloud hosted notes  </h1>
    <br />
    <br />
...
Functionality : Supports all CRUD operations, password hashing, cloud database. user verification done using JWT token.

![GitHub language count](https://img.shields.io/github/languages/count/jetfire77/NoteNest)

![GitHub top language](https://img.shields.io/github/languages/top/jetfire77/NoteNest?color=yellow)
...
1. Clone the repo
   ```sh
   git clone https://github.com/jetfire77/NoteNest
   ```
2. Install NPM packages
   ```sh
   npm install
   ```
3. Enter your JWT_KEY in `.env`
   ```js
   JWT_KEY = your - secret;
   ```
